...
* *MonacoImmunePanel*: 29 PBMC cell types from Monaco, G., et al. (Cell reports, 2019).
...
```R
PBMCs<-RCAv2::dataProjectMultiPanel(PBMCs,method=list("NovershternPanel", "MonacoImmunePanel", "GlobalPanel_CellTypes"),corMeth="pearson")
```
